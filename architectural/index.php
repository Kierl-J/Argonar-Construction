...
<div class="card card-custom">
    <div class="card-body text-center py-5">
        ...
        <p class="text-muted mb-4">Cost estimates for masonry, tiling, painting, roofing, and more.<br>Please log in or register to get started.</p>
...
<div class="card card-custom">
    <div class="card-body text-center py-5">
        ...
        <p class="text-muted mb-4">You need an active subscription to use the Architectural Estimate tool.<br>Choose a plan to get started.</p>
