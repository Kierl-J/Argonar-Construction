// Structural Estimate - Form JavaScript (add/remove rows, calculate costs)
...
$(document).ready(function() {
    ...
    $(document).on('change', '.category-input', function() {
        ...
        var unit = CATEGORY_UNITS[category] || 'cu.m';
    ...
    function calculateSummary() {
        ...
        $('#itemsBody tr').each(function() {
            ...
            if (category === 'concrete') totalConcrete += amount;
            else if (category === 'steel') totalSteel += amount;
            else totalFormwork += amount;
        });

        var subtotal = totalConcrete + totalSteel + totalFormwork;
        ...
        $('#totalConcrete').text(formatPeso(totalConcrete));
        $('#totalSteel').text(formatPeso(totalSteel));
        $('#totalFormwork').text(formatPeso(totalFormwork));
