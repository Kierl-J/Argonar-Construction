...
<div class="card card-custom">
    <div class="card-body text-center py-5">
        ...
        <p class="text-muted mb-4">Generate construction documents: scope of work, material requisitions, progress reports, and change orders.<br>Please log in or register to get started.</p>
...
<div class="card card-custom">
    <div class="card-body text-center py-5">
        ...
        <p class="text-muted mb-4">You need an active subscription to use the Document Generator tool.<br>Choose a plan to get started.</p>
